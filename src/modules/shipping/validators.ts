...
/**
 * The 64 districts of Bangladesh, for the admin form's autocomplete. Free text
 * is still allowed — the list is a convenience, not a constraint, so a store
 * that thinks in metro areas or upazilas is not blocked by it.
 */
